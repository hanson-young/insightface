...
def parse_arguments():
    ...
    parser.add_argument('--input-dir', default='/media/yj/hanson/face-recognition/china-cp-format',
                        type=str, help='Directory with unaligned images.')
    parser.add_argument('--output-dir', default='/media/yj/hanson/face-recognition/china-cp-112x112', type=str,
