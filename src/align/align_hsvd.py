...
def parse_arguments():
    ...
    parser.add_argument('--input-dir', type=str, help='Directory with unaligned add-eye-glasses.',
                        default='/media/handsome/data2/DataSet/FaceVerification/HSVD/clearn-face0816/recg')
    parser.add_argument('--output-dir', type=str, help='Directory with aligned face thumbnails.',
                        default='/media/handsome/data2/DataSet/FaceVerification/HSVD/clearn-face0816-112x112/recg')
