...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='/media/yj/hanson/face-recognition/heils-models/y1-arcface-emore/model,84',
                        help='path to load model.')

    parser.add_argument('--target', default='chip', help='test targets.')
    parser.add_argument('--embedding-bin', default='embedding_h2.bin', help='test targets.')
    ...
    ctx = []
    # ctx = mx.gpu_options(args.gpu)
    ctx.append(mx.gpu(args.gpu))
    # ctx = mx.cpu()
