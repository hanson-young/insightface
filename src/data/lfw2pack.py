...
# general
parser.add_argument('--data-dir', default='/media/hanson/0C5417A50C5417A5/Code/output/', help='')
parser.add_argument('--image-size', type=str, default='112,112', help='')
parser.add_argument('--output', default='/media/hanson/0C5417A50C5417A5/Code/output/lfw.bin', help='path to save.')
