...
NETWORK=y1
JOB=softmax12
MODELDIR="/media/yj/hanson/face-recognition/models/model-y1-softmax"
MODELDIR1="/media/yj/hanson/face-recognition/models/model-y1-softmax/1"
MODELDIR2="/media/yj/hanson/face-recognition/models/model-y1-softmax/2"
MODELDIR3="/media/yj/hanson/face-recognition/models/model-y1-softmax/3"
MODELDIR4="/media/yj/hanson/face-recognition/models/model-y1-softmax/4"
mkdir -p "$MODELDIR"
mkdir -p "$MODELDIR1"
mkdir -p "$MODELDIR2"
mkdir -p "$MODELDIR3"
...
#lr-batch-epoch: 0.01 6343 4
#CUDA_VISIBLE_DEVICES='0,1,3' python -u train_softmax.py --network y1 --ckpt 2 --loss-type 0 --lr 0.1  --per-batch-size 224 --emb-size 512 --fc7-wd-mult 10  --data-dir  $DATA_DIR --pretrained $PREFIX1,17 --prefix $PREFIX1

#CUDA_VISIBLE_DEVICES='0,1,3' python -u train_softmax.py --network y1 --ckpt 2 --loss-type 4  --lr 0.01 --lr-steps 40000,60000,70000 --wd 0.00004 --fc7-wd-mult 10 --emb-size 512 --per-batch-size 192 --margin-s 128 --data-dir $DATA_DIR --pretrained $PREFIX1,22 --prefix $PREFIX2


#$PREFIX2,39
CUDA_VISIBLE_DEVICES='1,2,3' python -u train_softmax.py --network y1 --ckpt 2 --loss-type 4  --lr 0.0001 --lr-steps 40000,60000,70000 --wd 0.00004 --fc7-wd-mult 10 --emb-size 512 --per-batch-size 212 --margin-s 64 --data-dir $DATA_DIR --pretrained $PREFIX3,17 --prefix $PREFIX3

#CUDA_VISIBLE_DEVICES='0,1,3' python -u train_softmax.py --network y1 --ckpt 2 --loss-type 4  --lr 0.00001 --lr-steps 40000,60000,70000 --wd 0.000001 --fc7-wd-mult 10 --emb-size 512 --per-batch-size 224 --margin-s 64 --data-dir $DATA_DIR --pretrained $PREFIX3,5 --prefix $PREFIX4
